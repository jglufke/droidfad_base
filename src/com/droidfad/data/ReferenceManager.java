 ...
 * -----------------------------------------------------------------------<br>
 *
 * ReferenceClasses are organized by _RefTypeDescr instances. For every 
 * ReferenceClass 3 _RefTypeDescr are created which are stored with names
 * id                  -  
 * type                - which is the simple class name of ReferenceClass  
 * ReferenceClass name - 
 *
 */
