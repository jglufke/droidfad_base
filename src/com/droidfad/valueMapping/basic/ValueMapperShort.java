 ...
 *
 */
public class ValueMapperShort extends ValueMapperNumber implements
		IValueMapper<Short> {

	public Short mapString2Value(String pValueString) {
		return (Short) super.mapString2Value(Short.class, pValueString);
	}

	public String mapValue2String(Object pValue) {
		super.checkType(Short.class, pValue);
